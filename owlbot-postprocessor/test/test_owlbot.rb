...
describe OwlBot do
  ...
  it "require ostruct for test helpers if missing" do
    content = <<~CONTENT
    ...
    expected_content = <<~CONTENT
      ...
      require "ostruct"
    CONTENT
    create_staging_file "test/helper.rb", content
    invoke_owlbot
    assert_gem_file "test/helper.rb", expected_content
  end

  it "does not require ostruct for test helpers if provided" do
    content = <<~CONTENT
      # Auto-generated by gapic-generator-ruby. DO NOT EDIT!
      require "ostruct"
      require "grpc"
    ...
    create_staging_file "test/helper.rb", content
    invoke_owlbot
    assert_gem_file "test/helper.rb", content
  end

  it "does not require ostruct for non-generated files" do
    content = <<~CONTENT
      require "grpc"
    CONTENT
    create_staging_file "test/helper.rb", content
